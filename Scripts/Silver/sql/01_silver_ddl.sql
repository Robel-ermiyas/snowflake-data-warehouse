-- =================================================================================
-- SILVER LAYER - LEGACY TABLE DDL (SQL Server Syntax)
-- 
-- Purpose: Original table definitions for Silver layer
-- Note: This is the legacy implementation before dbt migration
-- These tables will be replaced by dbt incremental models
-- =================================================================================
